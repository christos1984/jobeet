 ...
 */
final class Version20191008102705 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE jobs CHANGE token token VARCHAR(190) NOT NULL');
        $this->addSql('ALTER TABLE affiliates CHANGE token token VARCHAR(190) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE affiliates CHANGE token token VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
        $this->addSql('ALTER TABLE jobs CHANGE token token VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
